...
class ModelArguments:
    ...
    gt_pos_embed: str = ""
    backbone_model: str = field(default=None, metadata={"help": "bart_base/bart_large"})
...
class DataTrainingArguments:
    ...
    exp_description: str = field(default=None, metadata={"help": "用来对实验进行描述"})

    max_seq_len_per_utt: int = field(
        default=100, metadata={"help": "max_seq_len_per_utt"}
    )
    ...
    use_corefed_utt: Optional[str] = field(
        default=None,
        metadata={
            "help": "The  name of the dataset to compose (via the datasets library)."
        },
    ...
    speaker_column: Optional[str] = field(
        default=None,
        metadata={
            "help": "The name of the column in the datasets containing the speakers (for summarization)."
        },
    )
    unique_speaker_column: Optional[str] = field(
        default=None,
        metadata={
            "help": "The name of the column in the datasets containing the unique speakers (for summarization)."
        },
    )
