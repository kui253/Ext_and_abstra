...
from model import bart_model, graphtransformer, importance_attn
from dataclasses import asdict


def get_model_tokenizer(model_args, data_args):
    tokenizer = AutoTokenizer.from_pretrained(
        model_args.backbone_model, use_fast=model_args.use_fast_tokenizer
    )
    ...
    if "<sep>" not in tokenizer.additional_special_tokens:
        ...
        }  # ,"#Person2#","#Person1#","#Person3#","#Person4#","#Person5#","#Person6#"]}
